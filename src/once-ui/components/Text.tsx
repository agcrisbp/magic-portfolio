...
import { TextProps, CommonProps, ConditionalProps, SpacingProps } from '../interfaces'
import { ColorScheme, ColorWeight, TextVariant, SpacingToken } from '../types';

type TypeProps<T extends ElementType> = TextProps<T> & CommonProps & SpacingProps & ConditionalProps & ComponentPropsWithoutRef<T>;
