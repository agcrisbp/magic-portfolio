...
import { person, about, partners, social } from "@/app/resources/content";
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        {about.avatar.display && (
          <Column
            ...
            horizontal="center"
          >
            <AvatarDecoration src={person.avatar} size="xl" />
            { display.location && (
              <Flex
                  gap="8"
                  vertical="center">
            ...
            >
              {about.calendar.display && (
                ...
                >
                  ...
                  <Flex paddingX="8">Jadwalkan Panggilan</Flex>
                  <IconButton
                ...
                {about.work.experiences.map((experience, index) => (
                  <Column key={`${experience.company}-${experience.role}-${index}`} fillWidth>
                    ...
                    {experience.images.length > 0 && (
                      <Flex fillWidth paddingTop="m" paddingLeft="40" gap="24" wrap>
                        {experience.images.map((image, index) => (
                          <Flex key={index} radius="m" minWidth={image.width} height={image.height}>
                            <SmartImage
                              enlarge
                              radius="m"
